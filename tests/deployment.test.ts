...
test('production deployment uses remote authority boundaries', async () => {
  ...
  assert.match(dockerfile, /6a53d3e86b767ea32a77c92bc3b388d8530eddd1/);
  assert.match(dockerfile, /pax 0\.2\.0/);
  assert.match(dockerfile, /--locked/);
  assert.match(dockerfile, /pax --version/);
  assert.match(dockerfile, /USER node/);
  assert.match(workflow, /6a53d3e86b767ea32a77c92bc3b388d8530eddd1/);
  assert.match(workflow, /pax 0\.2\.0/);
  ...
  assert.equal(packageJson.dependencies['@appport/services'], '^0.4.5');
  ...
  assert.equal(packageJson.dependencies['@feltdb/core'], '^0.11.7');
